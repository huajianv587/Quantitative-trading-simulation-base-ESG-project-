...
S3_OUTPUT = f"s3://{BUCKET}/esg-finetune/output"

# 替换成你的 SageMaker Execution Role ARN
# AWS Console → IAM → Roles → 搜索 SageMaker → 复制 ARN
IAM_ROLE = "arn:aws:iam::935154424717:role/ESGtrainer"
