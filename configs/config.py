...
class Settings:
    def __init__(self):
        ...
        self.SCHEDULER_OWNER = _first_env("SCHEDULER_OWNER", default="quant-scheduler")
        ...
        self.PAPER_REWARD_SUBMIT_ENABLED = _env_bool("PAPER_REWARD_SUBMIT_ENABLED", default=False)
        self.RLVR_HORIZONS = _first_env("RLVR_HORIZONS", default="1,3,5")
        self.RLVR_WEIGHTS = _first_env("RLVR_WEIGHTS", default="0.30,0.30,0.40")
        ...
        self.PAPER_GATE_MIN_VALID_DAYS = _env_int("PAPER_GATE_MIN_VALID_DAYS", default=60)
