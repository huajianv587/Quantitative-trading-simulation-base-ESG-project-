...
const STRINGS = {
  en: {
    ...
    'nav.trading_workbench_hint': 'Paper trading, policies, portfolio, and execution',
    'nav.research_workbench': 'Research Workbench',
    'nav.research_workbench_hint': 'Research, factors, simulation, agents, and scoring',
    'nav.risk_approval': 'Risk & Approval',
    'nav.risk_approval_hint': 'Debate, risk gates, outcomes, and validation',
    'nav.data_models': 'Data & Models',
    'nav.data_models_hint': 'Connectors, datasets, models, RL, and backtests',
    'nav.ops_reports': 'Ops & Reports',
    'nav.ops_reports_hint': 'Reports, push rules, subscriptions, and release evidence',
    'nav.blueprint_center': 'Blueprint Center',
    'nav.blueprint_center_hint': 'Production capability status and module runs',
    ...
    'nav.status.ops': 'ops',
    'nav.status.blueprint': 'blueprint',
    ...
    'page.trading_safety': 'Trading Safety',
    'page.automation_timeline': 'Automation Timeline',
    ...
    'page.paper_performance': 'Paper Performance',
    'page.outcome_center': 'Outcome Center',
    'page.validation': 'Validation',
    'page.capabilities': 'Blueprint Capabilities',
    'page.models': 'Models',
    'page.reports': 'Reports',
    'page.ops_health': 'Release Health',
    'page.job_console': 'Job Console',
    'page.data_management': 'Data Sync',
    'page.data': 'Data Sync',
    'page.data_config_center': 'Data Config Center',
    'page.rl_lab': 'RL Lab',
  ...
  zh: {
    ...
    'nav.trading_workbench_hint': 'Paper 交易、策略、组合与执行',
    'nav.research_workbench': '研究工作台',
    'nav.research_workbench_hint': '研究、因子、模拟、智能体与评分',
    'nav.risk_approval': '风控与审批',
    'nav.risk_approval_hint': '辩论、风控门禁、结果追踪与验证',
    'nav.data_models': '数据与模型',
    'nav.data_models_hint': '连接器、数据集、模型、RL 与回测',
    'nav.ops_reports': '运维与报告',
    'nav.ops_reports_hint': '报告、推送规则、订阅与发布证据',
    'nav.blueprint_center': '蓝图能力中心',
    'nav.blueprint_center_hint': '生产能力状态与模块运行',
    'nav.market_intel': '市场智能',
    'nav.market_intel_hint': '研究流与实时信息链路',
    'nav.decision_hub': '决策中心',
    ...
    'nav.system_admin_hint': '规则、权限与系统配置',
    'nav.status.live': '实时',
    'nav.status.paper': 'Paper',
    'nav.status.audit': '审计',
    'nav.status.ops': '运维',
    'nav.status.blueprint': '蓝图',
    ...
    'page.trading_safety': '交易安全中心',
    'page.automation_timeline': '自动化时间线',
    ...
    'page.dataset': '研究数据集',
    'page.execution': '执行',
    'page.paper_performance': 'Paper 绩效',
    'page.outcome_center': '结果追踪',
    'page.validation': '策略验证',
    'page.capabilities': '蓝图能力中心',
    'page.models': '模型库',
    'page.reports': '报告中心',
    'page.ops_health': '发布健康检查',
    'page.job_console': 'Job 控制台',
    'page.data_management': '数据同步',
    'page.data': '数据同步',
    'page.data_config_center': '数据源配置中心',
    'page.rl_lab': 'RL 实验室',
    'page.chat': '研究对话',
    'page.score': 'ESG 评分',
    ...
    'common.features_limited': '后端不可用时，部分功能会显示降级或阻断状态',
...
const AUTO_TEXT_ZH = {
  ...
  Simulation: '情景模拟',
  'Trading Ops': '交易运维',
  'Trading Safety': '交易安全中心',
  'Automation Timeline': '自动化时间线',
  'Autopilot Policy': '自动驾驶策略',
  'Strategy Registry': '策略注册表',
  Portfolio: '投资组合',
  Backtest: '回测',
  Execution: '执行',
  'Paper Performance': 'Paper 绩效',
  'Outcome Center': '结果追踪',
  Validation: '策略验证',
  'Blueprint Capabilities': '蓝图能力中心',
  Models: '模型库',
  Reports: '报告中心',
  'Release Health': '发布健康检查',
  'Job Console': 'Job 控制台',
  'Data Sync': '数据同步',
  'Data Config Center': '数据源配置中心',
  'RL Lab': 'RL 实验室',
  'Research Chat': '研究对话',
  'ESG Score': 'ESG 评分',
  'Push Rules': '推送规则',
  ...
  'Market Open': '市场开盘',
  'Market Closed': '市场休市',
  'Paper Auto-Submit': 'Paper 自动提交',
  'Paper submit and monitoring': 'Paper 提交与监控',
  'Audit, outcomes, and model review': '审计、结果追踪与模型复盘',
  'Blueprint Center': '蓝图能力中心',
  ...
  'Ops & Reports': '运维与报告',
  'Degraded view': '降级视图',
  'Latest Run Result': '最近运行结果',
  'No run evidence yet': '暂无运行证据',
  'Open page': '打开页面',
};
...
const AUTO_PLACEHOLDER_ZH = {
  ...
  'comma-separated symbols': '用逗号分隔股票代码',
  'provider list': '数据源列表',
};
