...
export const ROUTES = {
  ...
  '/trading-safety': { module: () => import(`./pages/trading-safety-center.js?${VER}`), labelKey: 'page.trading_safety', icon: 'shield', group: 'trading' },
  '/automation-timeline': { module: () => import(`./pages/automation-timeline.js?${VER}`), labelKey: 'page.automation_timeline', icon: 'bar-chart-3', group: 'trading' },
  ...
  '/ops-health': { module: () => import(`./pages/ops-health.js?${VER}`), labelKey: 'page.ops_health', icon: 'shield', group: 'ops' },
  '/job-console': { module: () => import(`./pages/job-console.js?${VER}`), labelKey: 'page.job_console', icon: 'cpu', group: 'ops' },
  '/data-management': { module: () => import(`./pages/data-management.js?${VER}`), labelKey: 'page.data', icon: 'database', group: 'data' },
  '/data-config-center': { module: () => import(`./pages/data-config-center.js?${VER}`), labelKey: 'page.data_config_center', icon: 'database', group: 'data' },
